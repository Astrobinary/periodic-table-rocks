...
class App extends Component {
	constructor(props) {
		...
		this.clickBasic = this.clickBasic.bind(this);
		this.clickIonisation = this.clickIonisation.bind(this);
	...
	clickBasic(e) {
		...
		const basic = document.getElementById("basic-stats");

		console.log(basic.id);

		this.setState({ showStats: true, showIonisation: false, showHistory: false });

		this.removeOtherClasses(basic.id, basic);
	}

	clickIonisation(e) {
		this.setState({ disableHover: true });

		const ionisation = document.getElementById("ionisation");

		console.log(ionisation.id);

		this.setState({ showStats: false, showIonisation: true, showHistory: false });

		this.removeOtherClasses(ionisation.id, ionisation);
	}
	...
	clickHistory(e) {
		...
		this.setState({ showStats: false, showIonisation: false, showHistory: true });

		this.removeOtherClasses(history.id, history);
	}
	...
	removeOtherClasses(id, element) {
		const basic = document.getElementById("basic-stats");
		const ionisation = document.getElementById("ionisation");
		const history = document.getElementById("history");

		if (id !== basic.id) basic.className = "";

		if (id !== ionisation.id) ionisation.className = "";

		if (id !== history.id) history.className = "";
				...
				<div className="table">
					...
					<div className="row">
						...
						<div
							...
							onMouseLeave={this.hoverLeave}
							onClick={this.clickElement}
							className="element alkaline-earth"
						>
						...
						<div className="element blank top">
							...
							<div className="info-box details">
								<div className="element-badge">
									<div className="atomic-display">{this.state.element.number}</div>
								...
								<div className="info-badge">
									<div className="menu">
										<span id="basic-stats" className="selected" onClick={this.clickBasic}>
											Basic stats
										</span>
										<span id="ionisation" onClick={this.clickIonisation}>
											Electrons and Ionisation
										</span>
										<span id="history" onClick={this.clickHistory}>
											History
										</span>
									</div>
									...
									{this.state.showStats ? (
										<div className="stats">
											...
											<div data-tip="Density" className="density">
												...
												<div>
													{this.state.element.stats.density}
													&nbsp;g/cm<sup>3</sup>
												</div>
											</div>
									...
									{this.state.showIonisation ? <div className="ions">enter ion stuff here</div> : null}

									{this.state.showHistory ? <div className="ions">{this.state.element.history.brief}</div> : null}
								</div>
							</div>
							{/* Settings */}
							<div className="info-box settings">
								Hover over element for quick details, click element to interact with details.
							</div>
						</div>
						<div className="element blank" />
						<div className="element blank" />
					...
					{/* Buffer*/}
					<div className="row">
						<div className="element blank-half" />
						<div className="element blank-half" />
						<div className="element blank-half" />
						<div className="element blank-half" />
						<div className="element blank-half" />
